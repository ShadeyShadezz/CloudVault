...
export default function AboutPage() {
  return (
    <section className={`space-y-6 ${styles.textMain}`}>
      <h1 className="text-3xl font-bold">About CloudVault</h1>
      ...
      <h2 className="text-2xl font-semibold">The File Storage Problem</h2>
      ...
      <h3 className="text-xl font-semibold">Existing solutions</h3>
