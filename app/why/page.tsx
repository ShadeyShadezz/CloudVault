...
export default function WhyPage() {
  return (
    <section className={styles.pageSection}>
      <div>
        <h1 className={styles.pageTitle}>Why CloudVault?</h1>
        <p className={styles.pageDescription}>Traditional cloud storage fails when you need to manage diverse file types. CloudVault uses AI to understand your content, not just store it.</p>
      </div>

      <div className={styles.section}>
        <h2 className={styles.sectionTitle}>The CloudVault Difference</h2>
        <div className={styles.featureGrid}>
          <div className={styles.featureCard}>
            <h3 className={styles.featureTitle}>Universal File Support</h3>
          ...
          <div className={styles.featureCard}>
            <h3 className={styles.featureTitle}>Intelligent Search</h3>
      ...
      <div className={styles.section}>
        <h2 className={styles.sectionTitle}>Expected Challenges & Solutions</h2>
        <div className={styles.challengeGrid}>
          <div className={styles.challengeCard}>
            <h3 className={styles.challengeTitle}>Challenge: Large File Uploads</h3>
            <p className={styles.textMuted}>Uploading large video files, 3D models, and high-resolution images can be slow and prone to failures on unstable connections.</p>
          ...
          <div className={styles.challengeCard}>
            <h3 className={styles.challengeTitle}>Challenge: AI Training & Accuracy</h3>
            <p className={styles.textMuted}>Training AI models to accurately categorize diverse file types and content requires significant data and computational resources.</p>
          ...
          <div className={styles.challengeCard}>
            <h3 className={styles.challengeTitle}>Challenge: Storage Costs</h3>
            <p className={styles.textMuted}>Providing affordable storage while maintaining quality service requires balancing infrastructure costs with user accessibility.</p>
          ...
          <div className={styles.challengeCard}>
            <h3 className={styles.challengeTitle}>Challenge: User Adoption</h3>
            <p className={styles.textMuted}>Getting users to switch from familiar platforms like Google Drive or Dropbox requires demonstrating clear value and making migration easy.</p>
