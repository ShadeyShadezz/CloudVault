...
export default function FeaturesPage() {
  return (
    <section className={styles.pageSection}>
      <div>
        <h1 className={styles.pageTitle}>Features & Organization</h1>
        <p className={styles.pageDescription}>Manual Organization Control</p>
        ...
        <p className={styles.pageDescriptionSecondary}>No algorithms deciding for you - just pure, customizable organization that works the way you think. Your files, your rules, your way.</p>
      </div>

      <div className={styles.section}>
        <h2 className={styles.coreFeatureTitle}>Core Features</h2>
        <div className={styles.coreFeatureGrid}>
          <div className={styles.coreFeatureCard}>
            <div className={styles.featureIcon}>🏷️</div>
            <h3 className={styles.featureTitle}>Custom Tagging</h3>
            <p className={styles.textMuted}><strong>Manual:</strong> Choose from premade tags or create custom ones that match your workflow perfectly.</p>
          ...
          <div className={styles.coreFeatureCard}>
            ...
            <p className={styles.textMuted}><strong>Problem:</strong> You know what file you need, but can't remember its name or where you saved it.</p>
          ...
          <div className={styles.coreFeatureCard}>
            ...
            <p className={styles.textMuted}><strong>Problem:</strong> Your files are scattered and disorganized, making it hard to see what you have.</p>
          ...
          <div className={styles.coreFeatureCard}>
            <div className={styles.featureIcon}>👁️</div>
            <h3 className={styles.featureTitle}>Content Recognition</h3>
            <p className={styles.textMuted}><strong>Problem:</strong> Finding specific content within images or documents is nearly impossible without opening each file.</p>
      ...
      <div className={styles.section}>
        <h2 className={styles.sectionTitle}>Complete Feature Set</h2>
        <div className={styles.formatGrid}>
          <div className={styles.formatCard}>
            <h3 className={styles.formatTitle}>Images & Photos</h3>
      ...
      <div className={styles.section}>
        <h2 className={styles.sectionTitle}>Why Buy CloudVault Over Others?</h2>
      ...
      <div className={styles.section}>
        ...
        <p className={styles.textMuted}>Our pricing follows a repeated addition pattern - each tier doubles from the previous one, starting at just $2/month. Simple, predictable, and affordable.</p>
